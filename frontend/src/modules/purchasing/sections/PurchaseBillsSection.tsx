...
const SAMPLE_BILLS: PurchaseBill[] = [
  ...
  },
  {
    ...
    due_date: '2026-09-15',
    supplier_invoice_number: 'BA-INV-88219',
    currency_code: 'BDT',
    exchange_rate: '1.0000',
    subtotal_amount: '63700.00',
    discount_amount: '1000.00',
    tax_amount: '3135.00',
    grand_total: '65835.00',
    paid_amount: '65835.00',
    status: 'paid',
    payment_status: 'paid',
    notes: 'Wheat flour lot settled via Bank Wire TT-88390.',
    items: [
      {
        id: 402,
        uuid: 'pbi-402',
