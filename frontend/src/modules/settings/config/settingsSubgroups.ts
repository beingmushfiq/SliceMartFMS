  ...
  general: [
    {
      ...
      description: 'Official corporate registration numbers, legal entity name, and operational headquarters.',
      icon: Building2,
      keys: [
        'company_legal_name',
        'trade_license_no',
  ...
  assets: [
    {
      ...
      keys: [
        ...
        'auto_schedule_preventive_maintenance',
        'require_serial_number_tracking',
      ],
    },
  ],
  ...
  finance: [
    {
      ...
      description: 'Default VAT/tax percentages, withholding rates, auto-depreciation journal postings, and cost center budgets.',
      icon: Landmark,
      keys: [
        'default_vat_rate_percent',
        'withholding_tax_rate_percent',
        'auto_post_depreciation_entries',
        'enforce_cost_center_budget_check',
      ],
    },
  ],
  ...
  notifications: [
    {
      ...
      description: 'Thresholds and dispatch channels (in-app, email, SMS) for low stock warnings and large orders.',
      icon: Bell,
      keys: [
        'low_stock_notification_channels',
        'large_order_notification_channels',
        'large_order_threshold_amount',
        'qc_failure_sms_alerts_enabled',
      ],
    },
  ],
  ...
  security: [
    {
      ...
      description: 'Idle timeout windows, admin 2FA enforcement, lockout thresholds, and office IP range allowlists.',
      icon: ShieldCheck,
      keys: [
        'session_timeout_minutes',
        'require_2fa_for_admins',
        'max_login_attempts_before_lockout',
        'enforce_ip_whitelist_for_admin',
  ...
  reports: [
    {
      ...
      description: 'Default document export format (PDF/Excel), page sizes, orientations, and corporate letterhead.',
      icon: FileSpreadsheet,
      keys: [
        'default_export_format',
        'default_paper_size',
        'default_report_orientation',
        'include_company_header_on_exports',
      ],
    },
  ],
};
