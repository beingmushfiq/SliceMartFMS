...
| **Tests** | ✅ Frontend **128 tests across 7 files**, all passing. Backend **713 tests / 4122 assertions** across schema contracts, tenancy runtime contracts, auth/RBAC, catalogue/pricing, production, QC, stock operations, purchasing, sales/invoicing, delivery/couriers, HR/payroll, finance/GL, reporting/RMS, platform admin, storefront CMS, customer portal, fraud verification, and WhatsApp order generator — 100% green. |
